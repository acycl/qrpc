...
// Status describes the result of an RPC call.
type Status struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// A status code corresponding to a qrpc.Code value.
...
const file_status_proto_rawDesc = "" +
	"\n" +
	"\fstatus.proto\x12\x0eqrpc.status.v1\x1a\x19google/protobuf/any.proto\"f\n" +
	"\x06Status\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12.\n" +
	"\adetails\x18\x03 \x03(\v2\x14.google.protobuf.AnyR\adetailsB)Z'github.com/acycl/qrpc/internal/statuspbb\x06proto3"
...
var file_status_proto_goTypes = []any{
	(*Status)(nil),    // 0: qrpc.status.v1.Status
	(*anypb.Any)(nil), // 1: google.protobuf.Any
}
var file_status_proto_depIdxs = []int32{
	1, // 0: qrpc.status.v1.Status.details:type_name -> google.protobuf.Any
